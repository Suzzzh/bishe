...
<!--      用户数据-->
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户角色" align="center" key="roleName" prop="roles.0.roleName"  width="100" v-if="columns[3].visible" :show-overflow-tooltip="true"/>
          <el-table-column label="专业" align="center" key="deptName" prop="dept.deptName" width="150" v-if="columns[4].visible" :show-overflow-tooltip="true" />
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="归属专业" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" :show-count="true" placeholder="请选择归属专业" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
